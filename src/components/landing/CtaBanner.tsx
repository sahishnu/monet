    ...
    >
      ...
      <div className="relative z-10 flex w-full max-w-[var(--content-width)] flex-col items-center justify-center gap-6 px-[var(--page-gutter)] py-6 lg:px-24 lg:py-10">
        ...
        <div className="flex w-full max-w-lg flex-col items-stretch gap-3 sm:max-w-none sm:flex-row sm:justify-center">
          ...
          <button
            type="button"
            data-copy-email={cta.secondary.label}
            className="group flex min-h-12 items-center justify-center gap-2 border border-[#FFFFFF1F] px-12 py-3.5 text-[15px] font-medium text-[#FFFFFF99] transition hover:bg-white/5"
          >
            {cta.secondary.label}
            <svg data-icon="copy" className="h-4 w-4 shrink-0 opacity-50 transition group-hover:opacity-80" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round">
              <rect x="9" y="9" width="13" height="13" rx="2" />
              <path d="M5 15H4a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2h9a2 2 0 0 1 2 2v1" />
            </svg>
            <svg data-icon="check" className="hidden h-4 w-4 shrink-0 text-green-400" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
